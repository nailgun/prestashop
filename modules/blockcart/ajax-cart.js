...
var ajaxCart = {
	...
	updateCartEverywhere : function(jsonData) {
		...
		if(parseInt(jsonData.nbTotalProducts) > 0)
		{
			...
			var n = parseInt(jsonData.nbTotalProducts) % 100;
			if (n >= 5 && n <= 20)
			{
				...
				$('.ajax_cart_product_txt_v').each( function () {
					$(this).show();
				});
			}
			else 
		...
		{
			$('.ajax_cart_quantity, .ajax_cart_product_txt_s, .ajax_cart_product_txt, .ajax_cart_product_txt_v, .ajax_cart_total').each( function () {
					$(this).hide();
				});
