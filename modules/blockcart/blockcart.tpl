...
<div id="cart_block" class="block exclusive">
	...
	<div id="cart_block_summary" class="{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)}collapsed{else}expanded{/if}">
		...
		<span class="ajax_cart_product_txt_s hidden">{l s='products' mod='blockcart'}</span>
		<span class="ajax_cart_product_txt_v hidden">{l s='productv' mod='blockcart'}</span>
		<span class="ajax_cart_product_txt hidden">{l s='product' mod='blockcart'}</span>
