...
echo '			</div>
			...
			<div id="footer">
				<div style="float:left;margin-left:10px;padding-top:6px">
					<a href="http://www.prestashop.com/" target="_blank" style="font-weight:700;color:#666666">PrestaShop&trade; '._PS_VERSION_.'</a>
					<span class="pdv">| Русская версия подготовлена <a style="font-weight:700;color:#666666" href="http://prestadev.ru/" target="_blank">PrestaDev.ru</a></span>
					<br />
