...
class PDFCore extends PDF_PageGroupCore
{
	...
	protected static $_fpdf_core_fonts = array('dejavusanscondensed');
	...
	*/
	public function __construct($orientation='P', $unit='mm', $format='A4')
	{
		...
		TCPDF::__construct($orientation, $unit, $format);
		$this->_initPDFFonts();
	}
	...
	*/
	public function Footer()
	{
		...
		$this->Cell(190, 5, ' '.Tools::iconv('utf-8', self::encoding(), 'стр. ').$this->GroupPageNo().' / '.$this->PageGroupAlias(), 'T', 1, 'R');
